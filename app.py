...
def evaluate_generator():
    ...
    for q_id, matches_doc_id in test_set:
        ...
        query = Document()
        # Store question id and text in the query Document
        query.tags['id'] = q_id
        # Map question id to text and store it in the query Document
        ...
        for match_doc_id in matches_doc_id:
            match = Document()
            # Store groundtruth answer id and text in groundtruth Document
            match.tags['id'] = match_doc_id
            # Map answer id to text and store it in the groundtruth Document
